...
def get_bullshit():
    index1 = random.random() * len(li1)
    index2 = random.random() * len(li2)
    index3 = random.random() * len(li3)
    index4 = random.random() * len(li4)
    return (li1[int(index1)]+" "+li2[int(index2)]+" "+li3[int(index3)]+" "+li4[int(index4)]+".")
